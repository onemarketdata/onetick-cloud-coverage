# Canadian Consolidated Market Sample Enumerations
...
| 15
                          ...
                          | UBS Securities Canada Inc./UBS Valeurs Mobilieres Canada Inc.
...
| MATN
                        ...
                        | CBOE Canada - MatchNow

                                                                                                 |
| NEOD

                        | CBOE Canada - Neo Dark
...
| Enumeration ID
              ...
              | Enumeration Description
                                                                                                ...
                                                                                                |                                                                                                                                                                                                                                                   |
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|                             | ‘Values are exchange-specific - e.g. if the CLOUD_DB field is set to “TSX”

                                             | refer to the TRADE_TYPE values for TSX’
