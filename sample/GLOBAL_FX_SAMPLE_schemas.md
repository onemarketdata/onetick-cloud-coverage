# Global FX (Spots, Forwards, NDFs) Sample Schemas
...
### GLOBAL_FX_SAMPLE - DAY

Daily price and statistical data, e.g. closing price, settlement price, open interest

#### GLOBAL_FX_SAMPLE - DAY Table Schema
...
### GLOBAL_FX_SAMPLE - IDX

Index values

#### GLOBAL_FX_SAMPLE - IDX Table Schema
...
| REGION_ID      | string[4]   | Geographical region where a participant is located                                                                                                                                                                                     |

### GLOBAL_FX_SAMPLE - INTRADAY

Intraday Bid / Offer Quotes

#### GLOBAL_FX_SAMPLE - INTRADAY Table Schema
...
### GLOBAL_FX_SAMPLE - QTE

Best bid / offer quotes

#### GLOBAL_FX_SAMPLE - QTE Table Schema
...
### GLOBAL_FX_SAMPLE - STAT

Static data, e.g. ISIN, description, security type

#### GLOBAL_FX_SAMPLE - STAT Table Schema
...
### GLOBAL_FX_SAMPLE_BARS - DAY

Daily price and statistical data, e.g. closing price, settlement price, open interest

#### GLOBAL_FX_SAMPLE_BARS - DAY Table Schema
...
### GLOBAL_FX_SAMPLE_BARS - QTE_1M

1-minute quote bars

#### GLOBAL_FX_SAMPLE_BARS - QTE_1M Table Schema
