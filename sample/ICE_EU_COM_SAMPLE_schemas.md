# ICE Europe Commodities Sample Schemas
...
### ICE_EU_COM_SAMPLE - DAY

Daily price and statistical data, e.g. closing price, settlement price, open interest

#### ICE_EU_COM_SAMPLE - DAY Table Schema
...
### ICE_EU_COM_SAMPLE - MKT

Market phase / instrument status information

#### ICE_EU_COM_SAMPLE - MKT Table Schema
...
### ICE_EU_COM_SAMPLE - PRL_FULL

Full orderbook data, showing updates to each individual order (MBO)

#### ICE_EU_COM_SAMPLE - PRL_FULL Table Schema
...
### ICE_EU_COM_SAMPLE - QTE

Best bid / offer quotes

#### ICE_EU_COM_SAMPLE - QTE Table Schema
...
### ICE_EU_COM_SAMPLE - STAT

Static data, e.g. ISIN, description, security type

#### ICE_EU_COM_SAMPLE - STAT Table Schema
...
### ICE_EU_COM_SAMPLE - TRD

Trades

#### ICE_EU_COM_SAMPLE - TRD Table Schema
...
### ICE_EU_COM_SAMPLE_BARS - MKT

Market phase / instrument status information

#### ICE_EU_COM_SAMPLE_BARS - MKT Table Schema
...
### ICE_EU_COM_SAMPLE_BARS - QTE_1M

1-minute quote bars

#### ICE_EU_COM_SAMPLE_BARS - QTE_1M Table Schema
...
### ICE_EU_COM_SAMPLE_BARS - TRD_1M

1-minute trade bars

#### ICE_EU_COM_SAMPLE_BARS - TRD_1M Table Schema
...
### ICE_EU_COM_SAMPLE_BARS - VWAP_1H

1-hour VWAP bars

#### ICE_EU_COM_SAMPLE_BARS - VWAP_1H Table Schema
...
### ICE_EU_COM_SAMPLE_DAILY - DAY

Daily price and statistical data, e.g. closing price, settlement price, open interest

#### ICE_EU_COM_SAMPLE_DAILY - DAY Table Schema
...
### ICE_EU_COM_SAMPLE_DAILY - STAT

Static data, e.g. ISIN, description, security type

#### ICE_EU_COM_SAMPLE_DAILY - STAT Table Schema
