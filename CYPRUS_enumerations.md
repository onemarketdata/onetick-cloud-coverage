...
| A-
                          ...
                          | At The Close orders added to orderbook - Undefined

                                                                           |
| AA

                          | At The Close orders added to orderbook - Active

                                                                              |
| AH

                          | At The Close orders added to orderbook - Halted

                                                                              |
| AR

                          | At The Close orders added to orderbook - Re-opening

                                                                          |
| AS

                          | At The Close orders added to orderbook - Suspended

                                                                           |
| C-

                          | Closing price trading - Undefined

                                                                                            |
| CA

                          | Closing price trading - Active

                                                                                               |
| CH

                          | Closing price trading - Halted

                                                                                               |
| CR

                          | Closing price trading - Re-opening

                                                                                           |
| CS

                          | Closing price trading - Suspended

                                                                                            |
| P-

                          | Auction call - Undefined
...
| PR
                          ...
                          | Auction call - Re-opening

                                                                                                    |
| PS

                          | Auction call - Suspended
...
| TH
                          ...
                          | Continuous trading - Halted

                                                                                                  |
| TR

                          | Continuous trading - Re-opening

                                                                                              |
| TS

                          | Continuous trading - Suspended
