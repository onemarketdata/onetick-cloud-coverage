# Euronext (Paris / Amsterdam / Brussels / Lisbon / ETFs + Funds / Best of Book) Schemas
...
#### EURONEXT - PRL_FULL Table Schema
...
#### EURONEXT - REF_PRICE Table Schema
...
#### EURONEXT_BARS - DAY Table Schema
...
### EURONEXT_BARS - LAT_1M

1-minute Latency bars for real time delivered data

#### EURONEXT_BARS - LAT_1M Table Schema
...
#### EURONEXT_BARS - MKT Table Schema
...
### EURONEXT_BARS - QTE_1M

1-minute quote bars

#### EURONEXT_BARS - QTE_1M Table Schema
...
### EURONEXT_BARS - TRD_1D

Daily trade bars

#### EURONEXT_BARS - TRD_1D Table Schema
...
### EURONEXT_BARS - TRD_1M

1-minute trade bars

#### EURONEXT_BARS - TRD_1M Table Schema
...
### EURONEXT_BARS - VWAP_1H

1-hour VWAP bars

#### EURONEXT_BARS - VWAP_1H Table Schema
...
#### EURONEXT_DAILY - DAY Table Schema
...
#### EURONEXT_DAILY - STAT Table Schema
...
### EURONEXT_LATEST - SNAP_QTE

Latest Quotes for all Instruments in the venue

#### EURONEXT_LATEST - SNAP_QTE Table Schema
...
### EURONEXT_LATEST - SNAP_TRD

Latest Trade Prices for all Traded Instruments in the venue

#### EURONEXT_LATEST - SNAP_TRD Table Schema
