# Madrid Stock Exchange (SIBE) Schemas
...
Net Asset Value for investment funds

#### MADRID - NAV Table Schema

| Field    | Data Type   | Description                                                                                                                                                                                                                            |
|----------|-------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| NAV      | double      | Net Asset Value                                                                                                                                                                                                                        |
| NAV_DATE | string[8]   | Net Asset Value Date                                                                                                                                                                                                                   |
| OMDSEQ   | uint        | Sequence number allowing ticks of different types at the same timestamp to be sorted into the correct chronological order.  e.g. if a trade and a quote have the same timestamp, the one with the lower value of OMDSEQ arrived first. |
...
#### MADRID_BARS - LAT_1M Table Schema
...
#### MADRID_BARS - QTE_1M Table Schema
...
#### MADRID_BARS - TRD_1D Table Schema
...
#### MADRID_BARS - TRD_1M Table Schema
...
#### MADRID_BARS - VWAP_1H Table Schema
...
#### MADRID_DAILY - STAT Table Schema
...
#### MADRID_LATEST - SNAP Table Schema
...
### MADRID_LATEST - SNAP_QTE

Latest Quotes for all Instruments in the venue

#### MADRID_LATEST - SNAP_QTE Table Schema
