# Budapest Stock Exchange Schemas
...
| VOLUME_AUCTION         | double      | Volume traded during auctions. Includes all auction types.                                                                                                                                                                             |
| VOLUME_CLOSING_AUCTION | double      | Volume of the Closing Auction                                                                                                                                                                                                          |
| VOLUME_CONTINUOUS      | double      | Volume traded in the main orderbook during continuous trading                                                                                                                                                                          |
| VOLUME_DARK            | double      | Volume traded in a dark orderbook                                                                                                                                                                                                      |
| VOLUME_LIT             | double      | Volume traded in a lit orderbook                                                                                                                                                                                                       |
| VOLUME_OPENING_AUCTION | double      | Volume of the Opening Auction                                                                                                                                                                                                          |
| VOLUME_RFQ             | double      | Volume traded through an RFQ / RFC (Request for Quote / Request for Cross) process                                                                                                                                                     |
...
| MKT_SEGMENT         | string[48]  | Market segment on which the instrument is traded                                                                                                                                                                                           |
...
#### BUDAPEST_BARS - DAY Table Schema
...
#### BUDAPEST_BARS - MKT Table Schema
...
### BUDAPEST_BARS - QTE_1M

1-minute quote bars

#### BUDAPEST_BARS - QTE_1M Table Schema
...
### BUDAPEST_BARS - TRD_1D

Daily trade bars

#### BUDAPEST_BARS - TRD_1D Table Schema
...
### BUDAPEST_BARS - TRD_1M

1-minute trade bars

#### BUDAPEST_BARS - TRD_1M Table Schema
...
### BUDAPEST_BARS - VWAP_1H

1-hour VWAP bars

#### BUDAPEST_BARS - VWAP_1H Table Schema
...
#### BUDAPEST_DAILY - DAY Table Schema
...
#### BUDAPEST_DAILY - STAT Table Schema
