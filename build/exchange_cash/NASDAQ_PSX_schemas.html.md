...
#### NASDAQ_PSX - PRL_FULL Table Schema
...
### NASDAQ_PSX_DAILY - DAY

Daily price and statistical data, e.g. closing price, settlement price, open interest

#### NASDAQ_PSX_DAILY - DAY Table Schema
...
### NASDAQ_PSX_DAILY - STAT

Static data, e.g. ISIN, description, security type

#### NASDAQ_PSX_DAILY - STAT Table Schema
