# Athens Stock Exchange Enumerations
...
| Enumeration ID   | Enumeration Description                                     |
|------------------|-------------------------------------------------------------|
| -                | Char 2- Trading Status - Undefined                          |
| A                | Char 1 - Mkt Phase - At The Close orders added to orderbook |
| C                | Char 1 - Mkt Phase - Closing price trading                  |
| H                | Char 2 - Trading  Status - Halted                           |
| P                | Char 1 -Mkt Phase -  Auction call                           |
| R                | Char 2 - Trading Status - Re-opening                        |
| S                | Char 2 - Trading Status - Suspended                         |
| T                | Char 1 - Mkt Phase - Continuous trading                     |
