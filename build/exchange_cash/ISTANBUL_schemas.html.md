# Borsa Istanbul - Equities Schemas
...
#### ISTANBUL - STAT Table Schema

| Field            | Data Type   | Description                                                                                                                                                                                                                            |
|------------------|-------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| BLOOMBERG_TICKER | string[40]  | Bloomberg ticker symbol                                                                                                                                                                                                                |
...
| EXERCISE_TYPE    | string[8]   | Option exercise type (A - American, E - European, B - Bermudan, S - Asian)                                                                                                                                                             |
...
| TRADE_TYPE     | string[32]  | Type of trade                                                                                                                                                                                                                          |
...
#### ISTANBUL_BARS - DAY Table Schema
...
#### ISTANBUL_BARS - MKT Table Schema
...
### ISTANBUL_BARS - QTE_1M

1-minute quote bars

#### ISTANBUL_BARS - QTE_1M Table Schema
...
### ISTANBUL_BARS - TRD_1D

Daily trade bars

#### ISTANBUL_BARS - TRD_1D Table Schema
...
### ISTANBUL_BARS - TRD_1M

1-minute trade bars

#### ISTANBUL_BARS - TRD_1M Table Schema
...
### ISTANBUL_BARS - VWAP_1H

1-hour VWAP bars

#### ISTANBUL_BARS - VWAP_1H Table Schema
...
#### ISTANBUL_DAILY - DAY Table Schema
...
#### ISTANBUL_DAILY - STAT Table Schema
...
### ISTANBUL_DAILY - TRD_1D

Daily trade bars

#### ISTANBUL_DAILY - TRD_1D Table Schema
