...
|------------------|---------------------------------------|
| ‘””’             | Unspecified                           |
| AC               | Closing procedure                     |
| ACF              | Closing freeze (prior to uncrossing)  |
| AE               | Auction due to external market status |
| AO               | Opening procedure                     |
| AOF              | Opening freeze                        |
| AU               | Unscheduled auction                   |
| AUM              | Market order extension                |
| AUV              | Volatliity extension                  |
| AV               | Volatility auction                    |
| C                | Closed                                |
| CC               | Post-close                            |
| CO               | Pre-trading                           |
| H                | Halted                                |
| HE               | Halted due to external market status  |
| S                | Suspended                             |
