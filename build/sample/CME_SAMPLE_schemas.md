# CME Group (PCAP) Sample Schemas

A subset of symbols from the CME Group exchanges ( CBOT COMEX NYMEX CME Globex ), covering the Futures for products:  CL (Crude Oil), ES (E-Mini S&P 500), GC (Gold), NG (Henry Hub Natural Gas), NQ (E-Mini Nasdaq 100), ZC (Corn).   Between January 2,2024 and March 31, 2024.
...
#### CME_SAMPLE - FIXING Table Schema
...
#### CME_SAMPLE - PRL_FULL Table Schema
...
#### CME_SAMPLE_BARS - DAY Table Schema
...
#### CME_SAMPLE_BARS - MKT Table Schema
...
### CME_SAMPLE_BARS - QTE_1M

1-minute quote bars

#### CME_SAMPLE_BARS - QTE_1M Table Schema
...
### CME_SAMPLE_BARS - TRD_1D

Daily trade bars

#### CME_SAMPLE_BARS - TRD_1D Table Schema
...
### CME_SAMPLE_BARS - TRD_1M

1-minute trade bars

#### CME_SAMPLE_BARS - TRD_1M Table Schema
...
### CME_SAMPLE_BARS - VWAP_1H

1-hour VWAP bars

#### CME_SAMPLE_BARS - VWAP_1H Table Schema
...
### CME_SAMPLE_DAILY - DAY

Daily price and statistical data, e.g. closing price, settlement price, open interest

#### CME_SAMPLE_DAILY - DAY Table Schema
...
### CME_SAMPLE_DAILY - STAT

Static data, e.g. ISIN, description, security type

#### CME_SAMPLE_DAILY - STAT Table Schema
