# Australian Consolidated Equities Sample Schemas

A subset of symbols from all Australian venues, between January 2,2024 and March 31, 2024.
...
#### AU_COMP_SAMPLE - DAY Table Schema
...
#### AU_COMP_SAMPLE - NBBO Table Schema
...
#### AU_COMP_SAMPLE - QTE Table Schema
...
#### AU_COMP_SAMPLE - STAT Table Schema
...
#### AU_COMP_SAMPLE - TRD Table Schema
...
### AU_COMP_SAMPLE_BARS - DAY

Daily price and statistical data, e.g. closing price, settlement price, open interest

#### AU_COMP_SAMPLE_BARS - DAY Table Schema
...
### AU_COMP_SAMPLE_BARS - QTE_1M

1-minute quote bars

#### AU_COMP_SAMPLE_BARS - QTE_1M Table Schema
...
### AU_COMP_SAMPLE_BARS - TRD_1D

Daily trade bars

#### AU_COMP_SAMPLE_BARS - TRD_1D Table Schema
...
### AU_COMP_SAMPLE_BARS - TRD_1M

1-minute trade bars

#### AU_COMP_SAMPLE_BARS - TRD_1M Table Schema
...
### AU_COMP_SAMPLE_BARS - VWAP_1H

1-hour VWAP bars

#### AU_COMP_SAMPLE_BARS - VWAP_1H Table Schema
...
### AU_COMP_SAMPLE_DAILY - DAY

Daily price and statistical data, e.g. closing price, settlement price, open interest

#### AU_COMP_SAMPLE_DAILY - DAY Table Schema
...
### AU_COMP_SAMPLE_DAILY - STAT

Static data, e.g. ISIN, description, security type

#### AU_COMP_SAMPLE_DAILY - STAT Table Schema
