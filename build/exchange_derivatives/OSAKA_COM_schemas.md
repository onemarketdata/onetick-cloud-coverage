# Osaka Exchange - Commodity Derivatives (formerly TOCOM) Schemas
...
| LOCAL_CODE      | string[20]  | Code used to identify the security locally (generally a national numbering system)                                                                                                                                                         |
...
| PRODUCT_CODE    | string[15]  | Root code of a futures / options product, as specified by the exchange (e.g. CL for Crude Oil futures on NYMEX).   For inter-product spreads, PRODUCT_CODE will include both products, e.g. AB-CD for a spread between products AB and CD. |
...
### OSAKA_COM_BARS - QTE_1M

1-minute quote bars

#### OSAKA_COM_BARS - QTE_1M Table Schema
...
### OSAKA_COM_BARS - TRD_1D

Daily trade bars

#### OSAKA_COM_BARS - TRD_1D Table Schema
...
### OSAKA_COM_BARS - TRD_1M

1-minute trade bars

#### OSAKA_COM_BARS - TRD_1M Table Schema
...
### OSAKA_COM_BARS - VWAP_1H

1-hour VWAP bars

#### OSAKA_COM_BARS - VWAP_1H Table Schema
...
### OSAKA_COM_DAILY - STAT

Static data, e.g. ISIN, description, security type

#### OSAKA_COM_DAILY - STAT Table Schema
