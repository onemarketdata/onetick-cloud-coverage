...
#### CME_GLOBEX - FIXING Table Schema
...
#### CME_GLOBEX - MKT Table Schema

| Field        | Data Type   | Description                                                                                                                                                                                                                            |
|--------------|-------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| EVENT_CODE   | string[4]   | Event that triggered an instrument status update                                                                                                                                                                                       |
| EXCH_TIME    | nsectime    | Event timestamp, as provided by the exchange. For electronic trading this refers to the matching engine timestamp                                                                                                                      |
| MKT_PHASE    | string[25]  | Indicates the instrument’s current market phase, as specified by the trading venue                                                                                                                                                     |
| OMDSEQ       | uint        | Sequence number allowing ticks of different types at the same timestamp to be sorted into the correct chronological order.  e.g. if a trade and a quote have the same timestamp, the one with the lower value of OMDSEQ arrived first. |
...
#### CME_GLOBEX - PRL_FULL Table Schema
...
#### CME_GLOBEX_BARS - DAY Table Schema
...
### CME_GLOBEX_BARS - LAT_1M

1-minute Latency bars for real time delivered data

#### CME_GLOBEX_BARS - LAT_1M Table Schema
...
#### CME_GLOBEX_BARS - MKT Table Schema
...
### CME_GLOBEX_BARS - QTE_1M

1-minute quote bars

#### CME_GLOBEX_BARS - QTE_1M Table Schema
...
### CME_GLOBEX_BARS - TRD_1D

Daily trade bars

#### CME_GLOBEX_BARS - TRD_1D Table Schema
...
### CME_GLOBEX_BARS - TRD_1M

1-minute trade bars

#### CME_GLOBEX_BARS - TRD_1M Table Schema
...
### CME_GLOBEX_BARS - VWAP_1H

1-hour VWAP bars

#### CME_GLOBEX_BARS - VWAP_1H Table Schema
...
### CME_GLOBEX_DAILY - DAY

Daily price and statistical data, e.g. closing price, settlement price, open interest

#### CME_GLOBEX_DAILY - DAY Table Schema
...
### CME_GLOBEX_DAILY - STAT

Static data, e.g. ISIN, description, security type

#### CME_GLOBEX_DAILY - STAT Table Schema
...
### CME_GLOBEX_LATEST - SNAP_QTE

Latest Quotes for all Instruments in the venue

#### CME_GLOBEX_LATEST - SNAP_QTE Table Schema
...
### CME_GLOBEX_LATEST - SNAP_TRD

Latest Trade Prices for all Traded Instruments in the venue

#### CME_GLOBEX_LATEST - SNAP_TRD Table Schema
