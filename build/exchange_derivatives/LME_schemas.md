...
| UPDATE_TYPE  | string[24]  | Type of update                                                                                                                                                                                                                         |

### LME - IDX

Index values

#### LME - IDX Table Schema
...
#### LME - MKT Table Schema

| Field         | Data Type   | Description                                                                                                                                                                                                                            |
|---------------|-------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| FLOOR_SESSION | string[25]  | Free text field indicating the current floor trading session                                                                                                                                                                           |
| MKT_PHASE     | string[15]  | Indicates the instrument’s current market phase, as specified by the trading venue                                                                                                                                                     |
