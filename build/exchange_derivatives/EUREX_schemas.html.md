...
#### EUREX - MKT Table Schema

| Field      | Data Type   | Description                                                                                                                                                                                                                            |
|------------|-------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| EXCH_TIME  | nsectime    | Event timestamp, as provided by the exchange. For electronic trading this refers to the matching engine timestamp                                                                                                                      |
| MKT_COND   | string[4]   | Indicates any unusual market conditions                                                                                                                                                                                                |
| MKT_PHASE  | string[12]  | Indicates the instrument’s current market phase, as specified by the trading venue                                                                                                                                                     |
...
#### EUREX - SEC_GROUP Table Schema

| Field        | Data Type   | Description                                                                                                                                                                                                                            |
|--------------|-------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| GROUP_SYMBOL | string[32]  | Security Group for Options Contract                                                                                                                                                                                                    |
| OMDSEQ       | uint        | Sequence number allowing ticks of different types at the same timestamp to be sorted into the correct chronological order.  e.g. if a trade and a quote have the same timestamp, the one with the lower value of OMDSEQ arrived first. |
...
| EXCH_SYMBOL         | string[48]  | Ticker symbol specified by the exchange                                                                                                                                                                                                    |
...
| PRODUCT_ISIN        | string[12]  | Pseudo-ISIN assigned to a futures / options product                                                                                                                                                                                        |
...
#### EUREX_BARS - LAT_1M Table Schema
...
#### EUREX_BARS - QTE_1M Table Schema
...
#### EUREX_BARS - TRD_1D Table Schema
...
#### EUREX_BARS - TRD_1M Table Schema
...
#### EUREX_BARS - VWAP_1H Table Schema
...
#### EUREX_DAILY - TRD_1D Table Schema
...
#### EUREX_LATEST - SNAP Table Schema
...
### EUREX_LATEST - SNAP_QTE

Latest Quotes for all Instruments in the venue

#### EUREX_LATEST - SNAP_QTE Table Schema
