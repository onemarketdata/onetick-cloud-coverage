...
| FIRST_NOTICE_DATE
                 ...
                 | string[8]
                                                                                                                                  ...
                                                                                                                                  | Earliest date when holders of short futures positions can provide notice of their intention to deliver the underlying commodity (YYYYMMDD)
...
| FIRST_TRADING_DATE
                ...
                | string[8]
                                                                                                                                  ...
                                                                                                                                  | First date on which the instrument can be traded (YYYYMMDD)
...
| LAST_NOTICE_DATE
                  ...
                  | string[8]
                                                                                                                                  ...
                                                                                                                                  | Latest date when holders of short futures positions can provide notice of their intention to deliver the underlying commodity (YYYYMMDD)
...
| COMBO_TRADE_ID
                    ...
                    | string[20]
                                                                                                                                 ...
                                                                                                                                 | Links leg trades in outright instruments with the spread trade that generated them
...
### MIAX_FUT_BARS - DAY Table Schema
...
| ON_BOOK_VOLUME
                    ...
                    | double
                                                                                                                                     ...
                                                                                                                                     | Total volume traded through the orderbook
...
| SPREAD_VOLUME
                     ...
                     | double
                                                                                                                                     ...
                                                                                                                                     | Total volume originating from spread executions  [i.e. strategy leg trades reported in each outright leg when two spread orders are matched]
...
### MIAX_FUT_BARS - MKT Table Schema
...
| OMD_STATUS
                        ...
                        | string[64]
                                                                                                                                 ...
                                                                                                                                 | Indicates an instrument’s current trading status. Values are normalized across all DBs.
                                                                                                                                                                       ...
                                                                                                                                                                       |
### MIAX_FUT_BARS - QTE_1M

1-minute quote bars

### MIAX_FUT_BARS - QTE_1M Table Schema
...
| SPREAD_TWAP
                       ...
                       | double
                                        ...
                                        |
### MIAX_FUT_BARS - TRD_1D

Daily trade bars

### MIAX_FUT_BARS - TRD_1D Table Schema
...
| VWAP
                              ...
                              | double
                                                                                                                                     ...
                                                                                                                                     | Volume-weighted average price
                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                 |
### MIAX_FUT_BARS - TRD_1M

1-minute trade bars

### MIAX_FUT_BARS - TRD_1M Table Schema
...
| VWAP
                              ...
                              | double
                                                                                                                                     ...
                                                                                                                                     | Volume-weighted average price
                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                 |
### MIAX_FUT_BARS - VWAP_1H

1-hour VWAP bars

### MIAX_FUT_BARS - VWAP_1H Table Schema
...
### MIAX_FUT_DAILY - DAY Table Schema
...
### MIAX_FUT_DAILY - STAT Table Schema
