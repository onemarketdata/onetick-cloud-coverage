...
|------------------|-------------------------------------------------------|
| ‘””’             | No condition                                          |
| I                | Ask size consists only of implied liquidity           |
| O                | Ask size consists only of outright liquidity          |
| P                | Ask size contains both outright and implied liquidity |
...
|------------------|-------------------------------------------------------|
| ‘””’             | No condition                                          |
| I                | Bid size consists only of implied liquidity           |
| O                | Bid size consists only of outright liquidity          |
| P                | Bid size contains both outright and implied liquidity |
...
| CALL             | Auction call                                                                            |
| CIRAUCL          | Circuit breaker auction triggered by breach of static trading limits (call phase)       |
| CIRAUCLFRE       | Circuit breaker auction triggered by breach of static trading limits (uncrossing phase) |
