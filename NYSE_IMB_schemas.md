...
| SECURITY_STATUS
             ...
             | string[1]
                                                                                                                                  ...
                                                                                                                                  | Security Status Code
                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                          |
| SELL_SHORT_RESTRICTION_STATE

 | string[1]

                                                                                                                                  | Sell Short Restriction State

                                                                                                                                                                                                                                  |
| SELL_SHORT_TRIGGER_TIME

      | string[12]

                                                                                                                                 | Sell Short Trigger Time

                                                                                                                                                                                                                                       |
| SELL_SHORT_TRIGGERING_EXCHANGE_ID

 | string[1]

                                                                                                                                  | Sell Short Triggering Exchange ID

                                                                                                                                                                                                                             |
| SELL_SHORT_TRIGGERING_VOLUME
