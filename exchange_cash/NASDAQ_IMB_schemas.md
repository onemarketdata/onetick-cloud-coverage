...
#### NASDAQ_IMB - MKT Table Schema

| Field        | Data Type   | Description                                                                                                                                                                                                                            |
|--------------|-------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| BREACH_LVL   | string[1]   | Breach Level                                                                                                                                                                                                                           |
| EVENT_CODE   | string[1]   | Event that triggered an instrument status update                                                                                                                                                                                       |
| INTEREST     | string[1]   | Interest                                                                                                                                                                                                                               |
| IPO_PRICE    | double      | IPO Price                                                                                                                                                                                                                              |
| IPO_QUALIF   | string[1]   | IPO Qualifier                                                                                                                                                                                                                          |
| IPO_TIME     | msectime    | IPO Time                                                                                                                                                                                                                               |
| LVL1         | double      | Level 1                                                                                                                                                                                                                                |
| LVL2         | double      | Level 2                                                                                                                                                                                                                                |
| LVL3         | double      | Level 3                                                                                                                                                                                                                                |
| MESSAGE_TYPE | string[2]   | Message Type Index                                                                                                                                                                                                                     |
| OMDSEQ       | uint        | Sequence number allowing ticks of different types at the same timestamp to be sorted into the correct chronological order.  e.g. if a trade and a quote have the same timestamp, the one with the lower value of OMDSEQ arrived first. |
| REASON       | string[4]   | Reason                                                                                                                                                                                                                                 |
| REG_SHO      | string[1]   | Regulated Shares Outstanding                                                                                                                                                                                                           |
| STOCK        | string[16]  | Stock                                                                                                                                                                                                                                  |
| STOCK_LOCATE | int         | Stock Locate                                                                                                                                                                                                                           |
| TRACK_NUMBER | int         | Track Number                                                                                                                                                                                                                           |
| TRD_STATE    | string[1]   | Trade State                                                                                                                                                                                                                            |
