...
| BUY_ORDER_ID          | string[12]  | ID of the buy order involved in a trade                                                                                                                                                                                                           |
...
| SELL_ORDER_ID         | string[12]  | ID of the sell order involved in a trade                                                                                                                                                                                                          |
| SIZE                  | long        | TRD: Trade size, IND: Indicative size, PRL: Size at the relevant price point, PRL_FULL: Order size, RFQ: Size associated with a Request for Quote, RFC: Size associated with a Request for Cross                                                  |
| TICK_STATUS           | int         | Internal OneTick field. Always 0 unless hidden ticks are requested (e.g. SHOW_HIDDEN_TICKS).                                                                                                                                                      |
...
#### ATHENS_BARS - QTE_1M Table Schema
...
#### ATHENS_BARS - TRD_1D Table Schema
...
#### ATHENS_BARS - TRD_1M Table Schema
...
#### ATHENS_BARS - VWAP_1H Table Schema
...
#### ATHENS_DAILY - STAT Table Schema
...
#### ATHENS_DAILY - TRD_1D Table Schema
