# Stock Exchange of Thailand Schemas
...
### THAILAND - PRL_ODD_LOT

Odd lot orderbook data, for exchanges that have a separate book for odd lots

#### THAILAND - PRL_ODD_LOT Table Schema
...
| TICK_SIZE      | string[120] | Tick size / minimum price increment. All order prices must be a multiple of the tick size.                                                                                                                                             |
...
#### THAILAND_BARS - DAY Table Schema
...
#### THAILAND_BARS - MKT Table Schema
...
### THAILAND_BARS - QTE_1M

1-minute quote bars

#### THAILAND_BARS - QTE_1M Table Schema
...
### THAILAND_BARS - TRD_1D

Daily trade bars

#### THAILAND_BARS - TRD_1D Table Schema
...
### THAILAND_BARS - TRD_1M

1-minute trade bars

#### THAILAND_BARS - TRD_1M Table Schema
...
### THAILAND_BARS - VWAP_1H

1-hour VWAP bars

#### THAILAND_BARS - VWAP_1H Table Schema
...
#### THAILAND_DAILY - DAY Table Schema
...
#### THAILAND_DAILY - STAT Table Schema
...
### THAILAND_DAILY - TRD_1D

Daily trade bars

#### THAILAND_DAILY - TRD_1D Table Schema
