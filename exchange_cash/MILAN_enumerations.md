# Euronext Milan (Borsa Italiana) - Equities Enumerations
...
* MKT_PHASE (before 20230327) -
* MKT_PHASE (from 20230327) - Byte 1 (Orderbook state) -
* MKT_PHASE (from 20230327) - Byte 2 (Market period) -
* MKT_PHASE (from 20230327) - Byte 3 (Phase qualifier) -
* MKT_PHASE (from 20230327) - Byte 1 (Orderbook state) -
* MKT_PHASE (from 20230327) - Byte 3 (Phase qualifier) -
* MKT_PHASE (from 20230327) - Byte 1 (Orderbook state) -
* MKT_PHASE (from 20230327) - Byte 2 (Market period) -
...
#### MKT_PHASE (before 20230327) - Enumeration
...
| e                | Re-opening auction call                   |
| f                | Frozen                                    |
| g                | OPA auction call                          |
| H                | Halted                                    |
| I                | Re-opening auction call (circuit breaker) |
| J                | Halted (matching partition suspended)     |
| K                | Halted (trading system suspended)         |
| L                | Halt (circuit breaker)                    |
| P                | Regulatory halt                           |
| Q                | Quoting period                            |
...
#### MKT_PHASE (from 20230327) - Byte 1 (Orderbook state) - Enumeration

| Enumeration ID   | Enumeration Description   |
|------------------|---------------------------|
| ‘” “’            | Undefined                 |

#### MKT_PHASE (from 20230327) - Byte 2 (Market period) - Enumeration

| Enumeration ID   | Enumeration Description   |
|------------------|---------------------------|
| ‘” “’            | Undefined                 |

#### MKT_PHASE (from 20230327) - Byte 3 (Phase qualifier) - Enumeration
