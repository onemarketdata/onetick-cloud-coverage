# Philippine Stock Exchange Schemas
...
| LOT_SIZE       | string[150] | All standard order sizes must be an integer multiple of the Lot Size                                                                                                                                                                   |
| LOT_SIZE_TYPE  | string[8]   | Indicates the type of lot size carried by LOT_SIZE. Values are Static or Variable.                                                                                                                                                     |
