...
| DISCLOSED_SIZE   | int         | Disclosed order quantity                                                                                                                                                                                                               |
| EXCH_TIME        | nsectime    | Event timestamp, as provided by the exchange. For electronic trading this refers to the matching engine timestamp                                                                                                                      |
| IOC_FLAG         | string[1]   | Y - Immediate or Cancel (IOC) order, N - Not an IOC order                                                                                                                                                                              |
| MKT_ORDER_FLAG   | string[1]   | Y - Market order, N - Limit order                                                                                                                                                                                                      |
| OMD_PASSIVE_FLAG | string[1]   | OMD Passive Flag                                                                                                                                                                                                                       |
| OMDSEQ           | uint        | Sequence number allowing ticks of different types at the same timestamp to be sorted into the correct chronological order.  e.g. if a trade and a quote have the same timestamp, the one with the lower value of OMDSEQ arrived first. |
...
| STOP_LOSS_FLAG   | string[1]   | Y - Stop order, N - Not a stop order                                                                                                                                                                                                   |
| STOP_PRICE       | double      | Stop price; price limit at which a dormant stop order is activated and injected into the active order book                                                                                                                             |
