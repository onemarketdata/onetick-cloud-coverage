...
### NYSE_IMB - SECURITY_STATUS_MESSAGE

Security Status Message

#### NYSE_IMB - SECURITY_STATUS_MESSAGE Table Schema

| Field                             | Data Type   | Description                                                                                                                                                                                                                            |
|-----------------------------------|-------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| HALT_CONDITION                    | string[1]   | Hald Condition                                                                                                                                                                                                                         |
| INDICATION_HIGH_PRICE             | double      | Indication High Price                                                                                                                                                                                                                  |
| INDICATION_LOW_PRICE              | double      | Indication Low Price                                                                                                                                                                                                                   |
| MARKET_STATE                      | string[1]   | Market State                                                                                                                                                                                                                           |
| MESSAGE_TYPE                      | int         | Message Type Index                                                                                                                                                                                                                     |
| OMDSEQ                            | uint        | Sequence number allowing ticks of different types at the same timestamp to be sorted into the correct chronological order.  e.g. if a trade and a quote have the same timestamp, the one with the lower value of OMDSEQ arrived first. |
| SECURITY_STATUS                   | string[1]   | Security Status Code                                                                                                                                                                                                                   |
| SELL_SHORT_RESTRICTION_STATE      | string[1]   | Sell Short Restriction State                                                                                                                                                                                                           |
| SELL_SHORT_TRIGGER_TIME           | string[12]  | Sell Short Trigger Time                                                                                                                                                                                                                |
| SELL_SHORT_TRIGGERING_EXCHANGE_ID | string[1]   | Sell Short Triggering Exchange ID                                                                                                                                                                                                      |
| SELL_SHORT_TRIGGERING_VOLUME      | long        | SECURITY_STATUS_MESSAGE                                                                                                                                                                                                                |
| SOURCE_TIME                       | nsectime    | Source Time                                                                                                                                                                                                                            |
| SYMBOL                            | string[16]  | Exchange Symbol                                                                                                                                                                                                                        |
| SYMBOL_INDEX                      | int         | Symbol Index                                                                                                                                                                                                                           |
| SYMBOL_SEQUENCE_NUM               | int         | Symbol Sequence Number                                                                                                                                                                                                                 |

### NYSE_IMB - SYMBOL_INDEX_MAPPING

Symbol Index Mapping

#### NYSE_IMB - SYMBOL_INDEX_MAPPING Table Schema

| Field                   | Data Type   | Description                                                                                                                                                                                                                            |
|-------------------------|-------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| EXCHANGE_CODE           | string[1]   | Exchange ID                                                                                                                                                                                                                            |
| MESSAGE_TYPE            | int         | Message Type Index                                                                                                                                                                                                                     |
| MINIMUM_PRICE_INCREMENT | double      | Minimum Price Increment                                                                                                                                                                                                                |
| OMDSEQ                  | uint        | Sequence number allowing ticks of different types at the same timestamp to be sorted into the correct chronological order.  e.g. if a trade and a quote have the same timestamp, the one with the lower value of OMDSEQ arrived first. |
| PREVIOUS_CLOSE_PRICE    | double      | Previous Close Price                                                                                                                                                                                                                   |
| PREVIOUS_CLOSE_VOLUME   | long        | Previous Close Volume                                                                                                                                                                                                                  |
| PRICE_RESOLUTION        | int         | Price Resolution                                                                                                                                                                                                                       |
| ROUND_LOT_SIZE          | int         | Round Lot Size                                                                                                                                                                                                                         |
| ROUND_LOTS_ACCEPTED     | string[1]   | Round Lots Accepted                                                                                                                                                                                                                    |
| SECURITY_TYPE           | string[1]   | SECURITY_TYPE                                                                                                                                                                                                                          |
| SOURCE_TIME             | nsectime    | Source Time                                                                                                                                                                                                                            |
| SYMBOL                  | string[16]  | Exchange Symbol                                                                                                                                                                                                                        |
| SYMBOL_INDEX            | int         | Symbol Index                                                                                                                                                                                                                           |
| SYMBOL_SEQUENCE_NUM     | int         | Symbol Sequence Number                                                                                                                                                                                                                 |
| SYSTEM_ID               | int         | System ID                                                                                                                                                                                                                              |
| UNIT_OF_TRADE           | int         | Unit of Trade                                                                                                                                                                                                                          |
