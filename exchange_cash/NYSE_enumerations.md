# New York Stock Exchange NYSE Enumerations
...
| U
                                 ...
                                 | Extended hours + out of sequence
...
| P
                                 ...
                                 | Closing auction extended due to extreme closing imbalance

                                                                                  |
| R

                                 | Significant closing imbalance (imbalance >500 round lots at 15:50 ET)
...
| 1
                                 ...
                                 | Auction will run + interest exists within the auction collars or imbalance is zero

                                                         |
| 2

                                 | Auction will not run because of an imbalance outside the auction collars

                                                                   |
| 3

                                 | Auction will not run and will transition to the closing auction instead
...
| 1
                                 ...
                                 | Imbalance freeze - MOO/LOO orders cannot be entered / modified / cancelled
...
| 1
                                 ...
                                 | Market-wide circuit breaker (MWCB) halt level 1

                                                                                            |
| 2

                                 | Market-wide circuit breaker (MWCB) halt level 2

                                                                                            |
| 3

                                 | Market-wide circuit breaker (MWCB) halt level 3
...
| F
                                 ...
                                 | ETF component prices not available
...
| V
                                 ...
                                 | Intraday indicative value not available
...
| Pre-Market
                        ...
                        | Extended hours - pre-market session

                                                                                                        |
| Post-Market

                       | Extended hours - post-market session
...
| N
                                 ...
                                 | Fill (non-printable - does not appear in trade tickers as the execution is part of an aggregated auction print)

                            |
| O

                                 | Partial fill (non-printable)
