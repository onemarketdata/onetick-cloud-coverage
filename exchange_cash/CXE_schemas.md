...
#### CXE - IND Table Schema

| Field              | Data Type   | Description                                                                                                                                                                                                                            |
|--------------------|-------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| AUCTION_PRICE_TYPE | string[5]   | Type of auction price.                                                                                                                                                                                                                 |
...
| MKT_SEGMENT    | string[30]  | Market segment on which the instrument is traded                                                                                                                                                                                       |
